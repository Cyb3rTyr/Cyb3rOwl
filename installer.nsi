...
!define MUI_HEADERIMAGE_BITMAP "wizard.bmp"      # Path to the banner image for the welcome page
...
Section "Install"
    ...
    File "banner_owl.png"  # Ensure banner_owl.png is in the same directory as this script or provide correct path
